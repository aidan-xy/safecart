...
// alert("SAFE CART LOADED");
//
// function injectBadges() {
//     const listings = document.querySelectorAll('a[href*="/item/"]');
//
//     listings.forEach((listing) => {
//         const card = listing.closest('div');
//         if (!card) return;
//
//         if (card.querySelector('.safecart-badge')) return;
//
...
//
//         // TEMPORARY placeholder (replace later with logo)
//         badge.innerHTML = `
//       <span style="
//         font-size:14px;
//         font-weight:bold;
