## P0
* Be able to scrape data from a webpage
* Recognize/flag and warn users about suspicious vendors/listings
...
## P2
* Use an ML or LLM algorithm to create a listing rating (1-100)
* Support for additional websites
* Recommend other listings selling the same item through clicking on the extension
* Sort/filter by trustworthiness score
